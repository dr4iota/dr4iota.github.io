import{r as c,j as r,i as Re,P as Ie,d as F,z as ge,E as Fe,g as Ae,e as Ge,f as Ye,h as Be,k as Je,l as We,m as Ke,L as Ze,n as ve,q as Qe,o as et,p as tt,t as nt,v as rt,w as ot,M as be,x as we,y as ze,A as $e,B as at,C as st}from"./other-p-I2a2oX.js";import{C as it,u as Ee,V as se,S as lt,B as ct,a as dt}from"./three-BM7bkSLB.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))s(t);new MutationObserver(t=>{for(const a of t)if(a.type==="childList")for(const u of a.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&s(u)}).observe(document,{childList:!0,subtree:!0});function n(t){const a={};return t.integrity&&(a.integrity=t.integrity),t.referrerPolicy&&(a.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?a.credentials="include":t.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function s(t){if(t.ep)return;t.ep=!0;const a=n(t);fetch(t.href,a)}})();const _e={sm:{button:"px-2 py-1 text-xs",item:"px-3 py-1 text-xs"},md:{button:"px-3 py-1.5 text-sm",item:"px-4 py-2 text-sm"},lg:{button:"px-4 py-2 text-base",item:"px-4 py-2 text-base"},xl:{button:"px-6 py-3 text-lg",item:"px-5 py-2.5 text-lg"}},Me=({label:o,options:e,selected:n,onChange:s,theme:t,size:a="md",align:u="left"})=>{const l=c.useRef(null),[i,d]=c.useState({}),m=()=>{if(l.current){const h=l.current.getBoundingClientRect(),z={top:`${h.bottom+4}px`,minWidth:`${h.width}px`};u==="left"?z.left=`${h.left}px`:z.right=`${window.innerWidth-h.right}px`,d(z)}};return r.jsxs(Re,{as:"div",className:"relative",children:[r.jsxs(Ie,{ref:l,onClick:m,className:F("flex justify-between items-center w-full rounded-md border shadow-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2",_e[a].button,t==="dark"?"border-gray-700 bg-gray-800 text-white hover:bg-gray-700 focus:ring-offset-gray-900 focus:ring-indigo-500":"border-gray-300 bg-white text-gray-700 hover:bg-gray-50 focus:ring-offset-gray-100 focus:ring-indigo-500"),children:[r.jsxs("span",{className:"truncate",children:[o&&`${o}: `,r.jsx("strong",{children:n})]}),r.jsx("span",{className:"ml-2 text-xs",children:"▼"})]}),r.jsx(ge,{as:c.Fragment,enter:"transition ease-out duration-100",enterFrom:"transform opacity-0 scale-95",enterTo:"transform opacity-100 scale-100",leave:"transition ease-in duration-75",leaveFrom:"transform opacity-100 scale-100",leaveTo:"transform opacity-0 scale-95",children:r.jsx(Fe,{style:i,className:F("fixed z-50 mt-1 w-auto rounded-md shadow-lg ring-1 ring-opacity-5 focus:outline-none",{"origin-top-left":u==="left","origin-top-right":u==="right"},t==="dark"?"bg-gray-800 ring-gray-400 border border-gray-600":"bg-white ring-black"),children:r.jsx("div",{className:"py-1",children:e.map(h=>r.jsx(Ae,{children:({focus:z})=>r.jsx("button",{onClick:()=>s(h.value),className:F("w-full text-left block whitespace-nowrap",_e[a].item,z?t==="dark"?"bg-gray-700 text-white":"bg-gray-100 text-gray-900":t==="dark"?"text-gray-300":"text-gray-700"),children:h.name})},h.value))})})})]})},ut=({client:o,slot:e,style:n={display:"block"},format:s="auto",responsive:t="true"})=>(c.useEffect(()=>{try{(window.adsbygoogle=window.adsbygoogle||[]).push({})}catch(a){console.error("AdSense error:",a)}},[]),r.jsx("ins",{className:"adsbygoogle",style:n,"data-ad-client":o,"data-ad-slot":e,"data-ad-format":s,"data-full-width-responsive":t})),Le=c.createContext(void 0),ht=({children:o})=>{const[e,n]=c.useState(()=>{if(typeof window<"u"){const a=localStorage.getItem("theme");return a==="light"||a==="dark"?a:window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light"}return"light"});c.useEffect(()=>{const a=window.document.documentElement;e==="dark"?a.classList.add("dark"):a.classList.remove("dark")},[e]);const s=()=>{n(a=>a==="light"?"dark":"light")},t=c.useMemo(()=>({theme:e,toggleTheme:s}),[e]);return r.jsx(Le.Provider,{value:t,children:o})},Z=()=>{const o=c.useContext(Le);if(o===void 0)throw new Error("useTheme must be used within a ThemeProvider");return o},he=o=>{if(o.startsWith("#")||o.startsWith("/"))return!1;try{return new URL(o,window.location.origin).hostname!==window.location.hostname}catch{return!1}},ne=()=>new URLSearchParams(window.location.hash.substring(1)),de=o=>{const e=ne();Object.entries(o).forEach(([s,t])=>{t==null?e.delete(s):e.set(s,t)});const n=e.toString();window.location.hash.substring(1)!==n&&(window.location.hash=n)},Pe=({icon:o,options:e,align:n="left"})=>{const{theme:s}=Z();return r.jsxs(Re,{as:"div",className:"relative inline-block text-left",children:[r.jsx("div",{children:r.jsx(Ie,{className:"p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700",children:o})}),r.jsx(ge,{as:c.Fragment,enter:"transition ease-out duration-100",enterFrom:"transform opacity-0 scale-95",enterTo:"transform opacity-100 scale-100",leave:"transition ease-in duration-75",leaveFrom:"transform opacity-100 scale-100",leaveTo:"transform opacity-0 scale-95",children:r.jsx(Fe,{className:F("absolute z-50 mt-2 w-auto rounded-md shadow-lg ring-1 ring-opacity-5 focus:outline-none",{"right-0 origin-top-right":n==="right","left-0 origin-top-left":n==="left"},s==="dark"?"bg-gray-800 ring-gray-400 border border-gray-600":"bg-white ring-black"),children:r.jsx("div",{className:"py-1",children:e.map(t=>{const a=he(t.href);return r.jsx(Ae,{children:({focus:u})=>r.jsxs("a",{href:t.href,target:a?"_blank":"_self",rel:"noopener noreferrer",className:F("flex items-center justify-between px-4 py-2 text-base w-full whitespace-nowrap",u?s==="dark"?"bg-gray-700 text-white":"bg-gray-100 text-gray-900":s==="dark"?"text-gray-300":"text-gray-700"),children:[r.jsxs("div",{className:"flex items-center",children:[t.icon&&r.jsx("span",{className:"mr-3 h-5 w-5",children:t.icon}),t.name]}),a&&r.jsx(Ge,{className:"h-4 w-4"})]})},t.key)})})})})]})},ft=({appName:o,help:e,config:n,showUserProfile:s})=>{const{theme:t,toggleTheme:a}=Z(),u=()=>{if(!e)return null;const i=r.jsx(We,{className:"h-8 w-8"});return typeof e=="string"?r.jsx("a",{href:e,target:he(e)?"_blank":"_self",rel:"noopener noreferrer",className:"p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700",children:i}):Array.isArray(e)&&e.length>0?r.jsx(Pe,{icon:i,options:e,align:"right"}):null},l=()=>{if(!n)return null;const i=r.jsx(Ke,{className:"h-8 w-8"});return typeof n=="string"?r.jsx("a",{href:n,target:he(n)?"_blank":"_self",rel:"noopener noreferrer",className:"p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700",children:i}):Array.isArray(n)&&n.length>0?r.jsx(Pe,{icon:i,options:n,align:"right"}):null};return r.jsxs("header",{className:"bg-gray-100 dark:bg-gray-800 pt-4 pb-1 px-4 flex justify-between items-center border-b border-gray-200 dark:border-gray-700",children:[r.jsx("h1",{className:"text-xl font-bold",children:o}),r.jsxs("nav",{className:"flex items-center space-x-2",children:[r.jsx("button",{onClick:a,className:"p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700",children:t==="light"?r.jsx(Ye,{className:"h-8 w-8"}):r.jsx(Be,{className:"h-8 w-8"})}),u(),l(),s&&r.jsx("button",{className:"p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700",children:r.jsx(Je,{className:"h-8 w-8"})})]})]})},mt=({children:o,adSenseConfig:e,...n})=>{const[s,t]=c.useState(!0),[a,u]=c.useState(!1),l=e?.client&&e?.slot;c.useEffect(()=>{const z=()=>{const j=(window.visualViewport?.height??window.innerHeight)*.01;document.documentElement.style.setProperty("--vh",`${j}px`)},x=()=>{t((window.visualViewport?.height??window.innerHeight)>=600),u(window.innerWidth>=1280),z()};x();const y=window.visualViewport??window;return y.addEventListener("resize",x),()=>{y.removeEventListener("resize",x)}},[]);const i=l?e?.height??90:0,d=l?e?.width??300:0,m=l&&a,h=r.jsxs("div",{className:"w-full h-full flex flex-col bg-gray-50 text-gray-900 dark:bg-gray-900 dark:text-gray-100 overflow-hidden",children:[s&&r.jsx(ft,{...n}),r.jsx("main",{className:"flex-grow min-h-0 p-0 md:p-2",children:o})]});return l?r.jsxs("div",{className:"flex items-stretch flex-"+(m?"row":"col"),children:[r.jsx("div",{className:m?"h-screen":"w-screen",style:m?{width:`calc(100vw - ${d}px)`}:{height:`calc(100vh - ${i}px)`},children:h}),r.jsx("div",{style:m?{width:`${d}px`}:{height:`${i}px`},children:r.jsx(ut,{client:e.client,slot:e.slot})})]}):r.jsx("div",{className:"w-screen h-screen",children:h})},pt=({isOpen:o,onClose:e,title:n,children:s,size:t="lg"})=>{const{theme:a}=Z(),u=l=>{switch(l){case"sm":return"w-80 max-w-sm max-h-60";case"md":return"w-10/12 max-w-2xl max-h-[70vh]";case"lg":return"w-11/12 max-w-4xl max-h-[80vh]";case"xl":return"w-full max-w-6xl max-h-[90vh]";default:return"w-11/12 max-w-4xl max-h-[80vh]"}};return r.jsx(ge,{appear:!0,show:o,as:c.Fragment,children:r.jsxs(Ze,{as:"div",className:F("relative z-50",a),onClose:e,children:[r.jsx(ve,{as:c.Fragment,enter:"ease-out duration-300",enterFrom:"opacity-0",enterTo:"opacity-100",leave:"ease-in duration-200",leaveFrom:"opacity-100",leaveTo:"opacity-0",children:r.jsx("div",{className:"fixed inset-0 bg-black bg-opacity-25"})}),r.jsx("div",{className:"fixed inset-0 overflow-y-auto",children:r.jsx("div",{className:"flex min-h-full items-center justify-center p-0 text-center",children:r.jsx(ve,{as:c.Fragment,enter:"ease-out duration-300",enterFrom:"opacity-0 scale-95",enterTo:"opacity-100 scale-100",leave:"ease-in duration-200",leaveFrom:"opacity-100 scale-100",leaveTo:"opacity-0 scale-95",children:r.jsxs(Qe,{className:F(u(t),"transform rounded-2xl bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-xl transition-all flex flex-col border border-gray-200 dark:border-gray-600 overflow-y-hidden"),children:[r.jsx(et,{as:"h3",className:"text-lg font-medium leading-6 text-gray-900 dark:text-gray-100",children:n}),r.jsx("button",{onClick:e,className:"absolute top-4 right-4 p-1 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700",children:r.jsx(tt,{className:"h-6 w-6 text-gray-900 dark:text-gray-100"})}),r.jsx("div",{className:"mt-4 flex-1 text-gray-900 dark:text-gray-100 overflow-y-auto",children:s})]})})})})]})})},gt=({label:o,min:e,max:n,value:s,onChange:t,theme:a,valueLabel:u=d=>Math.round(d),posToVal:l=d=>e+(n-e)*d,valToPos:i=d=>(d-e)/(n-e)})=>{const d=c.useRef(null),m=c.useCallback(v=>{if(d.current){const g=d.current.getBoundingClientRect(),f=Math.max(0,Math.min(1,(v-g.left)/g.width));t(l(f))}},[t,l]),h=v=>{v.preventDefault(),m(v.clientX);const g=C=>{m(C.clientX)},f=()=>{document.removeEventListener("mousemove",g),document.removeEventListener("mouseup",f)};document.addEventListener("mousemove",g),document.addEventListener("mouseup",f)},z=v=>{v.preventDefault(),v.touches.length>0&&m(v.touches[0].clientX);const g=C=>{C.touches.length>0&&m(C.touches[0].clientX)},f=()=>{document.removeEventListener("touchmove",g),document.removeEventListener("touchend",f)};document.addEventListener("touchmove",g),document.addEventListener("touchend",f)},x=i(s),y=a==="dark"?"0 1px 2px rgba(0, 0, 0, 0.5)":"0 1px 2px rgba(255, 255, 255, 0.2)",j=x>.5,P=x>.25&&x<.5||x>.75;return r.jsx("div",{className:"w-full px-3",children:r.jsxs("div",{ref:d,onMouseDown:h,onTouchStart:z,className:"relative w-full h-6 cursor-pointer",style:{touchAction:"none"},children:[r.jsx("div",{className:F("w-full h-full rounded-full",a==="dark"?"bg-gray-700":"bg-gray-300")}),r.jsx("div",{className:F("absolute top-0 left-0 h-full rounded-full",a==="dark"?"bg-indigo-500":"bg-indigo-600"),style:{width:`${x*100}%`}}),r.jsxs("div",{className:"absolute inset-0 pointer-events-none",children:[o&&r.jsx("span",{className:F("absolute top-1/2 -translate-y-1/2 text-xs font-medium",a==="dark"?"text-gray-200":j?"text-white":"text-gray-800"),style:{...j?{left:"10px"}:{right:"10px"},textShadow:j?y:"none"},children:o}),r.jsx("span",{className:F("absolute top-1/2 -translate-y-1/2 text-xs font-mono",a==="dark"?"text-gray-200":P?"text-white":"text-gray-800"),style:{...P?{right:`calc(${100-x*100}% + 14px)`}:{left:`calc(${x*100}% + 14px)`},textShadow:P?y:"none"},children:u(s)})]}),r.jsx("div",{className:F("absolute top-0 w-6 h-6 rounded-full shadow-md z-10",a==="dark"?"bg-sky-400":"bg-sky-500"),style:{left:`calc(${x*100}% - 12px)`}})]})})},xt=36,Te=1e3,yt=10,K=(o,e,n,s,t,a,u)=>{if(n.length===0)return null;let l=null;const[i,d]=[s[0]-t/2,s[1]+a/2];for(let m=0;m<n.length;m++){const h=n[m],z=(h[0]-i)/t*u.width,x=(d-h[1])/a*u.height,y=Math.sqrt(Math.pow(o-z,2)+Math.pow(e-x,2));(l===null||y<l.distance)&&(l={index:m,distance:y})}return l&&l.distance<xt?l:null},vt=({zoom:o,setZoom:e,center:n,setCenter:s,viewWidth:t,viewHeight:a,aspect:u,baseViewSize:l=4,onShowInfo:i,controlPoints:d=[],initialControlPoints:m=[],onControlPointsChange:h,minControlPoints:z,maxControlPoints:x})=>{const[y,j]=c.useState(null),P=c.useRef(y);P.current=y;const[v,g]=c.useState(!1),f=c.useRef(null),C=c.useRef(null),U=c.useCallback(()=>{e(1),s([0,0])},[e,s]),Y=c.useCallback(()=>{const b=P.current;if(!(!h||!b)){if(b.type==="point"){if(z===void 0||d.length<=z)return;const p=d.filter((w,M)=>M!==b.index);h(p)}else{if(x===void 0||d.length>=x)return;const p=[...d,b.coords];h(p)}j(null)}},[d,x,z,h]),$=c.useCallback((b,p,w)=>{const M=b-w.left,N=p-w.top,T=K(M,N,d,n,t,a,w);if(T)j({type:"point",index:T.index,flashing:!0});else{const _=n[0]-t/2+M/w.width*t,k=n[1]+a/2-N/w.height*a;j({type:"space",coords:[_,k],flashing:!0})}f.current=window.setTimeout(()=>{Y(),f.current=null},Te)},[n,d,Y,a,t]),R=nt({onPointerDown:({event:b})=>{b.preventDefault();const p=b.target.getBoundingClientRect();if(!p)return;const{clientX:w,clientY:M}=b,N=w-p.left,T=M-p.top,_=K(N,T,d,n,t,a,p);_?(g(!0),j({type:"point",index:_.index,flashing:!1})):j(null),i&&(C.current={x:w,y:M},f.current=window.setTimeout(()=>{$(w,M,p)},Te))},onPointerUp:({event:b})=>{g(!1);const p=b.target.getBoundingClientRect();if(!p)return;const{clientX:w,clientY:M}=b,N=w-p.left,T=M-p.top,_=K(N,T,d,n,t,a,p);j(_?{type:"point",index:_.index,flashing:!1}:null),f.current&&(clearTimeout(f.current),f.current=null)},onPointerMove:({event:b})=>{if(v)return;const p=b.target.getBoundingClientRect();if(!p)return;const{clientX:w,clientY:M}=b;if(f.current&&C.current){const X=w-C.current.x,E=M-C.current.y;Math.sqrt(X*X+E*E)>yt&&(clearTimeout(f.current),f.current=null,j(null))}const N=w-p.left,T=M-p.top,_=K(N,T,d,n,t,a,p);if(j(_?{type:"point",index:_.index,flashing:!1}:X=>X?.type==="point"?null:X),!i)return;const k=w-p.left,I=M-p.top,V=n[0]+(k/p.width-.5)*t,H=n[1]+(.5-I/p.height)*a;i([V,H])},onDrag:({event:b,first:p,movement:[w,M],xy:[N,T],memo:_})=>{f.current&&(clearTimeout(f.current),f.current=null,j(I=>I?.type==="point"?{...I,flashing:!1}:null)),b.preventDefault();const k=b.target.getBoundingClientRect();if(k){if(p||!_){const I=N-k.left,V=T-k.top;if(h){const H=K(I,V,d,n,t,a,k);if(H)return{dragMode:"point",pointIndex:H.index}}return{dragMode:"canvas",startCenter:n}}if(_.dragMode==="point"){if(!h)return _;const I=N-k.left,V=T-k.top,H=n[0]-t/2+I/k.width*t,X=n[1]+a/2-V/k.height*a,E=[...d];return E[_.pointIndex]=[H,X],h(E),_}if(_.dragMode==="canvas"){const{startCenter:I}=_;if(!I)return _;const V=w/k.width*t,H=M/k.height*a;return s([I[0]-V,I[1]+H]),_}}},onPinch:({event:b,first:p,offset:[w]})=>{b.preventDefault(),p&&(f.current&&(clearTimeout(f.current),f.current=null),j(null)),e(w)},onWheel:({event:b,delta:[,p]})=>{if(p===0)return;const w=b.target.getBoundingClientRect();if(!w)return;const M=b.clientX-w.left,N=b.clientY-w.top,T=1.1,_=p<0?o*T:o/T;let k,I;u>=1?(I=l/_,k=I*u):(k=l/_,I=k/u);const V=M/w.width-.5,H=.5-N/w.height,X=n[0]+V*(t-k),E=n[1]+H*(a-I);e(_),s([X,E])},onDoubleClick:({event:b})=>{b.preventDefault();const p=b.target.getBoundingClientRect();if(!p)return;const w=b.clientX-p.left,M=b.clientY-p.top;if(h){const N=K(w,M,d,n,t,a,p);if(N&&m&&m[N.index]){const T=[...d];T[N.index]=m[N.index],h(T);return}}U()},onClick:({event:b})=>{if(!i)return;const p=b.currentTarget.getBoundingClientRect();if(!p)return;const{clientX:w,clientY:M}=b,N=w-p.left,T=M-p.top,_=n[0]+(N/p.width-.5)*t,k=n[1]+(.5-T/p.height)*a;i([_,k])}},{eventOptions:{passive:!1},drag:{from:()=>[0,0],filterTaps:!0,threshold:10},pinch:{from:()=>[o,0]}}),L={touchAction:"none",userSelect:"none",WebkitUserSelect:"none",WebkitTouchCallout:"none",WebkitTapHighlightColor:"transparent"};return{controlHandlers:{...R(),onContextMenu:b=>b.preventDefault(),style:L},highlightedPoint:y}};function bt({canvasName:o="canvas",parameterName:e="control point"}={}){return`### Mouse Controls:
...
- **Add ${e}:** Long-press on an empty area to add a new ${e}.
- **Remove ${e}:** Long-press on an existing ${e} to remove it.
- **Reset ${e}:** Double-tap a ${e} to reset its position.`}const je=5e3,wt=500,Ce=25,zt=({setAspect:o})=>{const{size:e}=Ee();return c.useEffect(()=>{o(e.width>0&&e.height>0?e.width/e.height:1)},[e,o]),null},$t=({xRange:o,yRange:e,theme:n,worldToScreen:s,center:t,gridTooDense:a})=>{const u=c.useMemo(()=>{const i=[],[d,m]=o,[h,z]=e,x=n==="dark"?"rgba(200, 200, 200,":"rgba(100, 100, 100,",y="0.8)",j="0.5)";for(let P=Math.ceil(d);P<=Math.floor(m);P++){const v=s([P,h]);if(!v)continue;const g=P===0;a&&!g||i.push(r.jsx("div",{className:"absolute",style:{left:v[0],top:0,width:1,height:"100%",backgroundColor:x+(g?y:j),transform:g?"translateX(-50%)":void 0}},`v-${P}`))}for(let P=Math.ceil(h);P<=Math.floor(z);P++){const v=s([d,P]);if(!v)continue;const g=P===0;a&&!g||i.push(r.jsx("div",{className:"absolute",style:{left:0,top:v[1],width:"100%",height:1,backgroundColor:x+(g?y:j),transform:g?"translateY(-50%)":void 0}},`h-${P}`))}return i},[o,e,n,s,a]),l=c.useMemo(()=>{const{pos:i}=fe([0,0],t,o,e),d=s(i);if(!d)return null;const m=n==="dark"?"rgba(200, 200, 200, 0.8)":"rgba(100, 100, 100, 0.8)";return r.jsx("div",{className:"absolute",style:{left:d[0],top:d[1],width:12,height:12,borderRadius:"50%",backgroundColor:m,transform:"translate(-50%, -50%)"}})},[t,o,e,n,s]);return r.jsxs(r.Fragment,{children:[u,l]})},te={default:{width:24,height:24,borderRadius:"50%",border:"4px solid white",cursor:"grab",mixBlendMode:"difference"},square:{width:24,height:24,border:"4px solid white",cursor:"grab",mixBlendMode:"difference"},diamond:{width:24,height:24,transform:"rotate(45deg)",border:"4px solid white",cursor:"grab",mixBlendMode:"difference"},triangle:{width:26,height:26,clipPath:"polygon(50% 15%, 100% 85%, 0% 85%)",cursor:"grab",filter:"drop-shadow(0 0 3px white)",mixBlendMode:"difference"},plus:{width:26,height:26,clipPath:"polygon(30% 0%, 70% 0%, 70% 30%, 100% 30%, 100% 70%, 70% 70%, 70% 100%, 30% 100%, 30% 70%, 0% 70%, 0% 30%, 30% 30%)",cursor:"grab",filter:"drop-shadow(0 0 3px white)",mixBlendMode:"difference"},star:{width:26,height:26,clipPath:"polygon(50% 0%, 61% 35%, 98% 35%, 68% 57%, 79% 91%, 50% 70%, 21% 91%, 32% 57%, 2% 35%, 39% 35%)",cursor:"grab",filter:"drop-shadow(0 0 3px white)",mixBlendMode:"difference"}},_t=o=>{if(typeof o=="number"){const e=Object.keys(te);return te[e[o%e.length]||"default"]}return typeof o=="string"&&te[o]?te[o]:te.default};function fe(o,e,n,s){const[t,a]=o,[u,l]=n,[i,d]=s;if(t>=u&&t<=l&&a>=i&&a<=d)return{pos:o,clipped:!1};const[m,h]=e,z=t-m,x=a-h;let y=1/0;const j=1e-9;if(Math.abs(z)>j){const g=(u-m)/z,f=(l-m)/z;if(g>0){const C=h+g*x;C>=i&&C<=d&&(y=Math.min(y,g))}if(f>0){const C=h+f*x;C>=i&&C<=d&&(y=Math.min(y,f))}}if(Math.abs(x)>j){const g=(i-h)/x,f=(d-h)/x;if(g>0){const C=m+g*z;C>=u&&C<=l&&(y=Math.min(y,g))}if(f>0){const C=m+f*z;C>=u&&C<=l&&(y=Math.min(y,f))}}if(y!==1/0&&y>0)return{pos:[m+y*z,h+y*x],clipped:!0};const P=Math.max(u,Math.min(l,t)),v=Math.max(i,Math.min(d,a));return{pos:[P,v],clipped:!0}}const Mt=({children:o,initialZoom:e=1,initialCenter:n=[0,0],baseViewSize:s=4,onInfoOverlay:t,onViewChange:a,className:u,gl:l,controlPoints:i=[],initialControlPoints:d=[],onControlPointsChange:m,controlPointGroups:h=[],minControlPoints:z,maxControlPoints:x,showGrid:y=!0,frameloop:j="always"})=>{const{theme:P}=Z(),[v,g]=c.useState(e),[f,C]=c.useState(n),[U,Y]=c.useState(1),[$,R]=c.useState(!1),[L,Q]=c.useState(null),[b,p]=c.useState(0),w=c.useRef(null),M=c.useRef(null),N=c.useRef(null),[T,_]=c.useMemo(()=>{let S,A;return U>=1?(A=s/v,S=A*U):(S=s/v,A=S/U),[S,A]},[v,U,s]),k=c.useMemo(()=>({center:f,viewWidth:T,viewHeight:_,zoom:v}),[f,T,_,v]);c.useEffect(()=>{a&&a(k)},[k,a]);const I=c.useCallback(()=>{w.current&&clearTimeout(w.current),M.current&&clearTimeout(M.current),w.current=window.setTimeout(()=>{p(0),w.current=null},je),M.current=window.setTimeout(()=>{Q(null),M.current=null},je+wt)},[]),V=c.useCallback(S=>{!t&&i.length===0&&!y||(w.current&&clearTimeout(w.current),M.current&&clearTimeout(M.current),S&&Q(S),p(1),I())},[t,i.length,y,I]),H=c.useCallback(S=>{I(),m&&m(S)},[m,I]),{controlHandlers:X,highlightedPoint:E}=vt({zoom:v,setZoom:g,center:f,setCenter:C,viewWidth:T,viewHeight:_,aspect:U,baseViewSize:s,onShowInfo:V,controlPoints:i,initialControlPoints:d,onControlPointsChange:b>0?H:void 0,minControlPoints:z,maxControlPoints:x}),{style:qe,...Ue}=X,[J,W]=c.useMemo(()=>{const S=[f[0]-T/2,f[0]+T/2],A=[f[1]-_/2,f[1]+_/2];return[S,A]},[f,T,_]);c.useEffect(()=>()=>{w.current&&clearTimeout(w.current),M.current&&clearTimeout(M.current)},[]);const ee=c.useCallback(S=>{if(!N.current)return null;const{width:A,height:D}=N.current.getBoundingClientRect(),[O,q]=J,[G,B]=W,ce=(S[0]-O)/T*A,oe=(B-S[1])/_*D;return[ce,oe]},[J,W,T,_]),He=c.useMemo(()=>{if(!y)return null;let S=!1;if(N.current){const{width:A,height:D}=N.current.getBoundingClientRect(),O=A/T,q=D/_;(O<Ce||q<Ce)&&(S=!0)}return r.jsx("div",{className:"absolute inset-0 pointer-events-none z-5",style:{transition:"opacity 0.5s ease-out",opacity:b},children:r.jsx($t,{xRange:J,yRange:W,theme:P,worldToScreen:ee,center:f,gridTooDense:S})})},[y,b,J,W,P,ee,T,_,f]),Ve=c.useMemo(()=>{const S=O=>{const q=O?128:48,G=O?120:44;return{containerStyle:{width:q,height:q},highlightStyle:{width:G,height:G,borderWidth:O?46:8}}},A=i.map((O,q)=>{const{pos:G}=fe(O,f,J,W),B=ee(G);if(!B)return null;const ce=_t(h[q]),oe=E?.type==="point"&&E.index===q,ye=S(oe&&E.flashing);return r.jsxs("div",{className:"absolute",style:{left:B[0],top:B[1],transform:"translate(-50%, -50%)",display:"grid",placeItems:"center",...ye.containerStyle},children:[oe&&r.jsx("div",{className:E.flashing?"highlight-animated-flashing":"highlight-animated-normal",style:{gridColumn:1,gridRow:1,borderRadius:"50%",backgroundColor:"transparent",borderStyle:"solid",borderColor:"transparent",...ye.highlightStyle}}),r.jsx("div",{className:"control-point-animating",style:{...ce,gridColumn:1,gridRow:1}})]},q)});let D=null;if(E?.type==="space"){const{pos:O}=fe(E.coords,f,J,W),q=ee(O);if(q){const G=S(E.flashing);D=r.jsx("div",{className:"absolute",style:{left:q[0],top:q[1],transform:"translate(-50%, -50%)",display:"grid",placeItems:"center",...G.containerStyle},children:r.jsx("div",{className:E.flashing?"highlight-animated-flashing":"highlight-animated-normal",style:{gridColumn:1,gridRow:1,borderRadius:"50%",backgroundColor:"transparent",borderStyle:"solid",borderColor:"transparent",...G.highlightStyle}})})}}return A.every(O=>O===null)&&!D?null:r.jsxs("div",{className:"absolute inset-0 pointer-events-none z-20",style:{transition:"opacity 0.5s ease-out",opacity:b},children:[A,D]})},[i,f,J,W,ee,h,b,E]),Xe=c.useMemo(()=>{if(!L||$||!t)return null;const S=t(L,k);if(!S)return null;const A=typeof S=="string"?{"top-left":S}:S;return Object.keys(A).length===0?null:Object.entries(A).map(([D,O])=>{if(!O)return null;const q=O.trim().split(`
`);return r.jsx("div",{className:F("absolute m-1 pointer-events-none transition-opacity duration-500 ease-out z-10",{"top-0 left-0":D==="top-left","top-0 right-0 text-right":D==="top-right","bottom-0 left-0":D==="bottom-left","bottom-0 right-0 text-right":D==="bottom-right","top-0 left-1/2 -translate-x-1/2 text-center":D==="top-center","bottom-0 left-1/2 -translate-x-1/2 text-center":D==="bottom-center"}),style:{opacity:b},children:r.jsx("div",{className:F("p-1 rounded-md text-xs font-mono space-y-1",P==="dark"?"bg-gray-800/50 text-white":"bg-white/50 text-black"),children:q.map((G,B)=>r.jsx("div",{children:G},B))})},D)})},[L,$,t,P,b,k]);return r.jsxs("div",{ref:N,className:F("w-full h-full relative",u),style:qe,...Ue,children:[r.jsx("div",{className:"w-full h-full rounded-lg overflow-hidden bg-black",children:r.jsxs(it,{frameloop:j,gl:l,onCreated:({gl:S})=>{S.domElement.addEventListener("webglcontextlost",A=>{A.preventDefault(),R(!0)},!1)},children:[r.jsx(zt,{setAspect:Y}),o(k)]})}),$&&r.jsxs("div",{className:"absolute inset-0 bg-gray-800 bg-opacity-75 flex flex-col items-center justify-center z-9",children:[r.jsx("p",{className:"text-white text-2xl mb-4",children:"Graphics context lost"}),r.jsx("p",{className:"text-white text-lg mb-8",children:"This can happen on mobile devices. Please reload."}),r.jsx("button",{onClick:()=>window.location.reload(),className:"px-4 py-2 bg-indigo-600 text-white rounded hover:bg-indigo-700",children:"Reload"})]}),He,Xe,Ve]})};function ie(o,e){const n=o<0?"-":"+",s=Math.abs(o),t=e-1;if(t<=0)return n;if(s===0)return n+"0.0".padEnd(t,"0").substring(0,t);const a=String(Math.trunc(s));if(a.length<=t){const u=t-a.length;if(u>1){let l=u-1,i=s.toFixed(l);if(i.split(".")[0].length>a.length&&(l-=i.split(".")[0].length-a.length,l>=0?i=s.toFixed(l):i=String(Math.round(s))),i.length<=t)return n+i}if(a.length<=t){let l=a;return l.length<t&&(l+=".".repeat(t-l.length)),n+l}}if(t>=3){for(let l=t-4;l>=0;l--){let i=s.toExponential(l).replace("e+","e");if(i.length<=t)return n+i}let u=s.toExponential(0).replace("e+","e");if(u.length<=t)return n+u}if(s>1)return n+".".repeat(t);{const u="0.0000";return u.length<=t?n+u:n+"0.0".padEnd(t,"0").substring(0,t)}}function le(o,e,n=7,s="i"){const t=ie(o,n),a=ie(e,n);return`${t}${a}${s}`}function ke(o,e,n=7,s=["(",", ",")"]){const t=ie(o,n),a=ie(e,n);return`${s[0]}${t}${s[1]}${a}${s[2]}`}function Pt(o){return"min"in o&&"max"in o}class Oe{getMath(){return this.math}getControlPointMinMax(){return[void 0,void 0]}}class re extends Oe{constructor(e,n,s,t,a,u){super(),this.name=e,this.title=n,this.description=s,this.math=t,this.shader=a;let l,i,d;typeof u=="number"?(d=u,l=1,i=2e3):(d=u.initial,l=u.min,i=u.max);const m=z=>{const x=Math.log(l),y=Math.log(i);return Math.exp(x+(y-x)*z)},h=z=>{if(z<=l)return 0;if(z>=i)return 1;const x=Math.log(l),y=Math.log(i);return(Math.log(z)-x)/(y-x)};this.iterations={name:"iterations",displayName:"Iterations",type:"int",defaultValue:d,min:l,max:i,posToVal:m,valToPos:h}}getGuiParameters(){return[this.iterations]}getShaderCode(){return this.shader}getInitialGuiParameters(){return{iterations:this.iterations.defaultValue}}getControlPointUniforms(e){}getInitialControlPoints(){return[]}getCanvasOverlayString(e,n){}getControlPointValues(e){}getControlPointGroups(e){return[]}}class xe extends re{constructor(e,n,s,t,a,u,l){super(e,n,s,t,a,u),this.controlPointInfo=l}getInitialControlPoints(){return[this.controlPointInfo.initialValue]}getCanvasOverlayString(e,n){if(e.length>0)return`${this.controlPointInfo.name} = ${le(...e[0])}`}getControlPointValues(e){if(e.length>0)return[{label:this.controlPointInfo.name,value:le(...e[0])}]}getControlPointUniforms(e){if(e.length>0)return{[this.controlPointInfo.uniformName]:e[0]}}getControlPointGroups(e){return[0]}}const Tt=`The Newton fractal is generated by applying Newton's method, a numerical
...
`;function an(o,e,n){if(Array.isArray(n))if(n.length===2)o[e]={value:new se(n[0],n[1])};else if(n.length===3)o[e]={value:new dt(n[0],n[1],n[2])};else if(n.length>=4&&n.length%2===0){const s=[];for(let t=0;t<n.length;t+=2)s.push(new se(n[t],n[t+1]));o[e]={value:s}}else o[e]={value:n};else o[e]={value:n}}function sn(o,e,n){if(o.uniforms[e])if(Array.isArray(n))if(n.length===2)o.uniforms[e].value.fromArray(n);else if(n.length===3)o.uniforms[e].value.fromArray(n);else if(n.length>=4&&n.length%2===0){const s=[];for(let t=0;t<n.length;t+=2)s.push(new se(n[t],n[t+1]));o.uniforms[e].value=s}else o.uniforms[e].value=n;else o.uniforms[e].value=n}const ln=({fractal:o,center:e,viewWidth:n,viewHeight:s,parameters:t,controlPoints:a,colorScheme:u})=>{const l=Ee(m=>m.invalidate),i=c.useMemo(()=>{const m={FRACTAL_SHADER:o.getShaderCode(),EVALUATE_COLOR:tn(u)},h={center:{value:new se(...e)},viewWidth:{value:n},viewHeight:{value:s}};o.getGuiParameters().forEach(x=>{h[x.name]={value:t[x.name]}});const z=o.getControlPointUniforms(a);if(z)for(const[x,y]of Object.entries(z))an(h,x,y);return new lt({uniforms:h,vertexShader:rn,fragmentShader:on.replace(/%(\w+)%/g,(x,y)=>String(m[y]))})},[o,u]);c.useEffect(()=>{i.uniforms.center.value.fromArray(e),i.uniforms.viewWidth.value=n,i.uniforms.viewHeight.value=s,o.getGuiParameters().forEach(h=>{i.uniforms[h.name].value=t[h.name]});const m=o.getControlPointUniforms(a);if(m)for(const[h,z]of Object.entries(m))sn(i,h,z);l()},[i,e,n,s,t,a,l,o]);const d=c.useMemo(()=>{const m=new ct;return m.setDrawRange(0,3),m},[]);return r.jsx("mesh",{material:i,geometry:d})},Ne=De,cn=({initialFractal:o,initialColorScheme:e,onFractalChange:n,onColorSchemeChange:s})=>{const{theme:t}=Z(),[a,u]=c.useState(o),[l,i]=c.useState(a.getInitialGuiParameters()),[d,m]=c.useState(a.getInitialControlPoints()),[h,z]=c.useState(e||pe),x=Ne.map($=>({name:$.title,value:$.name})),y=$=>{const R=Ne.find(L=>L.name===$);R&&(u(R),n(R),i(R.getInitialGuiParameters()),m(R.getInitialControlPoints()),g(L=>L+1))},j=$=>{z($),s($)},P=Object.entries(nn).map(([$,R])=>({name:R,value:$})),[v,g]=c.useState(0),f=a.getGuiParameters().map($=>Pt($)?r.jsx("div",{className:"min-w-[150px] flex-[2_1_0] my-1",children:r.jsx(gt,{label:$.displayName,min:$.min,max:$.max,value:l[$.name],onChange:R=>i(L=>({...L,[$.name]:R})),theme:t,posToVal:$.posToVal,valToPos:$.valToPos})},$.name):null),C=a.getControlPointValues(d),[U,Y]=a.getControlPointMinMax();return r.jsxs("div",{className:F("w-full h-full flex flex-col landscape:flex-row overflow-hidden",t==="dark"?"bg-gray-900 text-white":"bg-gray-100 text-black"),children:[r.jsxs("div",{className:"flex-shrink-0 p-2 landscape:p-4 landscape:w-56 lg:w-64 overflow-y-auto overflow-x-hidden",children:[r.jsx("h2",{className:"hidden landscape:block text-lg font-bold w-full mb-2",children:"Controls"}),r.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[r.jsx("div",{className:"min-w-[140px] flex-1",children:r.jsx(Me,{options:x,selected:a.title,onChange:$=>y($),theme:t})}),r.jsx("div",{className:"min-w-[140px] flex-1",children:r.jsx(Me,{label:"Colors",options:P,selected:P.find($=>$.value===h)?.name,onChange:$=>j($),theme:t})}),f,C&&C.length>0&&r.jsx("div",{className:"w-full gap-0 py-2 rounded-md hidden landscape:flex landscape:flex-col",style:{backgroundColor:t==="dark"?"rgba(255,255,255,0.05)":"rgba(0,0,0,0.05)"},title:"Drag the control point on the canvas to change. Double-click to reset.",children:C.map($=>r.jsxs("div",{className:"w-full flex flex-wrap justify-between items-baseline gap-x-1",children:[r.jsx("p",{className:F("text-sm font-medium",t==="dark"?"text-gray-300":"text-gray-700"),children:$.label}),r.jsx("p",{className:F("text-base font-mono",t==="dark"?"text-gray-200":"text-gray-800"),children:$.value})]},$.label))})]})]}),r.jsx("div",{className:"flex-grow flex items-center justify-center pt-2.5 landscape:p-2 relative",style:{minWidth:0,minHeight:0},children:r.jsx(Mt,{baseViewSize:4,frameloop:"demand",onInfoOverlay:($,R)=>{const L=["[",", ","]"],Q=ke(R.center[0]-R.viewWidth/2,R.center[0]+R.viewWidth/2,7,L),b=ke(R.center[1]-R.viewHeight/2,R.center[1]+R.viewHeight/2,7,L),p={"top-left":le(...$),"top-right":`Re: ${Q}
Im: ${b}`},w=a.getCanvasOverlayString(d,l);return w&&(p["bottom-center"]=w),p},controlPoints:d,initialControlPoints:a.getInitialControlPoints(),onControlPointsChange:m,controlPointGroups:a.getControlPointGroups(d),minControlPoints:U,maxControlPoints:Y,gl:{powerPreference:"default",antialias:!1},children:({center:$,viewWidth:R,viewHeight:L})=>r.jsx(ln,{fractal:a,center:$,viewWidth:R,viewHeight:L,parameters:l,controlPoints:d,colorScheme:h})},v)})]})},dn=`This application allows you to explore the intricate beauty of various fractals.
...
`;var un={client:"ca-pub-5400548434612970",slot:"5745481735"};const ae=De;function hn(){const{theme:o}=Z(),e=c.useCallback(()=>{const v=["newton","mandelbrot","julia"],g=ae.filter(f=>v.includes(f.name));return g.length>0?g[Math.floor(Math.random()*g.length)]:ae[0]},[]),n=c.useRef(null);n.current===null&&(n.current=e());const s=c.useCallback(()=>{const g=ne().get("type");return ae.find(f=>f.name===g)||n.current},[n]),[t,a]=c.useState(s),[u,l]=c.useState(()=>ne().get("colors")||pe),[i,d]=c.useState(null);c.useEffect(()=>{const v=()=>{const g=ne(),f=g.get("type"),C=g.get("colors"),U=g.get("help"),Y=ae.find($=>$.name===f)||n.current;a(Y),l(C||pe),d(U==="math"?"math":U==="controls"?"controls":null)};return window.addEventListener("hashchange",v),v(),()=>window.removeEventListener("hashchange",v)},[]);const m=v=>{de({type:v.name})},h=v=>{de({colors:v})},z=()=>{de({help:null})},x=v=>{const g=ne();return g.set("help",v),v==="math"&&!g.has("type")&&g.set("type",t.name),`#${g.toString()}`},y=[{key:"controls",name:"Exploring the Fractal",href:x("controls"),icon:r.jsx(rt,{})},{key:"math",name:`About ${t.title} Fractal`,href:x("math"),icon:r.jsx(ot,{})}],j=()=>{if(i==="math"){const v=`## ${t.title} Fractal
...
${v}`;return r.jsx(be,{remarkPlugins:[ze,$e],rehypePlugins:[we],children:g})}return null},P=()=>i==="math"?`About ${t.title} Fractal`:i==="controls"?"Exploring the Fractal":"";return r.jsxs(r.Fragment,{children:[r.jsx(mt,{appName:"Fantastic Fractals",help:y,adSenseConfig:un,children:r.jsx(c.Suspense,{fallback:r.jsx("div",{children:"Loading..."}),children:r.jsx(cn,{initialFractal:t,initialColorScheme:u,onFractalChange:m,onColorSchemeChange:h},t.name)})}),r.jsx(pt,{isOpen:i!==null,onClose:z,title:P(),size:"xl",children:r.jsx("div",{className:F("prose dark:prose-invert max-w-none",o==="dark"?"dark":""),children:j()})})]})}function fn(){return r.jsx(ht,{children:r.jsx(hn,{})})}at.createRoot(document.getElementById("root")).render(r.jsx(st.StrictMode,{children:r.jsx(fn,{})}));
