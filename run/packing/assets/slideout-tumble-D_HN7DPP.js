...
# Certified: par 8 reproduced as the MINIMUM by an independent search over
# tessera's own move gate (2026-08-14), and the flat kingdom's optimal path
# replays here move for move.
#
...
marks: { goal: [[2, 2], [2, 3]] }
pieces:
  - { id: a, cells: [[0, 0], [1, 0]], lattice: true, symmetry: free }
  - { id: b, cells: [[0, 0], [0, 1]], lattice: true, symmetry: free }
  - id: c
    cells: [[1, 0], [2, 0], [2, 1]]
    lattice: true
    symmetry: free
  ...
  - id: e
    ...
    lattice: true
    symmetry: free
  - { id: f, cells: [[1, 0]], lattice: true, symmetry: free }
rules:
  motion: slide
...
info: "Blocks slide along the six directions — and here they may also tip over an edge:
  ...
  steps in a row is one move. Eight moves suffice here."
`;export{e as default};
