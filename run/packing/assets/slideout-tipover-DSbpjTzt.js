...
# Certified: par 10 reproduced as the MINIMUM (2026-08-14); the flat kingdom's
# optimal path replays move for move.
#
...
pieces:
  - id: a
    cells: [[1, 1], [2, 0], [2, 1], [3, 1]]
    lattice: true
    symmetry: free
  - { id: b, cells: [[0, 0]], lattice: true, symmetry: free }
  - { id: c, cells: [[1, 0]], lattice: true, symmetry: free }
  - { id: d, cells: [[1, 0], [2, 0]], lattice: true, symmetry: free }
  - id: e
    cells: [[0, 0], [1, 0], [2, 0]]
    lattice: true
    symmetry: free
...
info: "Blocks slide along the six directions — and here they may also tip over an edge:
  ...
  steps in a row is one move. The certified optimum is 10 moves."
`;export{e as default};
