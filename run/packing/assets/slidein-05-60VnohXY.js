const e=`id: slidein-05
title: medium · 5
genus: slidein
order: 324
par: 4
space: square
# MEDIUM — pentomino quartet LPTY. Reverse-constructed (guaranteed
...
pieces:
  ...
  - { id: s1, cells: [[0, 1], [1, 0], [1, 1], [1, 2], [1, 3]], symmetry: free, supply: { count: 1 } }
  - { id: s2, cells: [[0, 0], [1, 0], [1, 1], [1, 2], [2, 0]], symmetry: free, supply: { count: 1 } }
  - { id: s3, cells: [[0, 0], [0, 1], [0, 2], [1, 0], [1, 1]], symmetry: free, supply: { count: 1 } }
rules:
  motion: slide
  supply: free-pick
  terminal: complete
