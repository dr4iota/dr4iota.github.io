...
# Certified: par 16 reproduced as the MINIMUM (2026-08-14); the flat kingdom's
...
pieces:
  ...
  - id: b
    ...
    lattice: true
    symmetry: free
  - { id: c, cells: [[0, 0]], lattice: true, symmetry: free }
  - { id: d, cells: [[0, 0], [1, 0]], lattice: true, symmetry: free }
rules:
  motion: slide
...
info: "Blocks slide along the six directions — and here they may also tip over an edge:
  ...
  steps in a row is one move. The certified optimum is 16 moves."
`;export{e as default};
