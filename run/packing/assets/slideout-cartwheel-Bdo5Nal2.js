...
# exactly par 20 (2026-08-14). Minimality is parquet's Rust solver's — a search
...
pieces:
  - id: a
    ...
    lattice: true
    symmetry: free
  - { id: b, cells: [[0, 0], [1, 0]], lattice: true, symmetry: free }
  - { id: c, cells: [[1, 0], [2, 0]], lattice: true, symmetry: free }
...
info: "Blocks slide along the six directions — and here they may also tip over an edge:
  ...
  steps in a row is one move. The certified optimum is 20 moves."
`;export{e as default};
